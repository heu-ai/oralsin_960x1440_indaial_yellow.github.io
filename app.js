...
// homepage links
var homepage_links =  "https://oralsinindaial.com.br/"

// whatsapp links
var whatsapp_links = "https://api.whatsapp.com/send?phone=5547997420271&text=Ol%C3%A1%2C%20visitei%20o%20site%20Oral%20Sin%20Indaial%2C%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es"

// Privacy Policy link
var privacy_policy_link = "https://www.oralsin.com.br/politica_de_privacidade"

// Subject and Recepients
var subject =  "Oral Sin Creative - Indaial"
...
function APICall(n){
  ...
  fetch('https://demo.infuseads.com:8081/core/key-count/?id=22', {
    method: 'POST',
    body: x,
    headers: {
...
function pg1func(op){
    ...
    enviar.onclick= function(){if(name.value!="" && phone.value!=""){document.getElementById("contact_form").submit(); contact_info.name= name.value; contact_info.phone_no=phone.value;
